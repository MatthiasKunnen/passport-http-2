 ...
 *
 * For further details on HTTP Basic authentication, refer to [RFC 2617: HTTP Authentication:
 * Basic and Digest Access Authentication](http://tools.ietf.org/html/rfc2617)
 *
...
DigestStrategy.prototype._challenge = function () {
    ...
    let challenge = `Digest realm="${this._realm}"`;
    if (this._domain) {
